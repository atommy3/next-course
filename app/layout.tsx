...
/*
a MetaData object can be exported in any page.tsx or layout.tsx file.

When child directories' exported metadata
specify their title, it will be substituted inside this
title.template, replacing the %s.
*/
